...
def login():
    ...
    if request.method == 'POST' and form.validate():
        ...
        # set username, which is also a foreign key of Image dataset
...
@bp_auth.route('/generator')
def generator():
    return render_template('generator_select_algorithm.html')

# @bp_auth.route('/canny',methods = ['POST', 'GET']) 
# def canny(): 
#    if request.method == 'POST' :
#       return redirect(url_for('auth.generator_enter_parameter_canny'))
